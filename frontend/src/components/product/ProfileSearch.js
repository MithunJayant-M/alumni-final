...
export default function ProfileSearch() {
    const dispatch = useDispatch();
    const { profiles, loading, error, profilesCount, resPerPage } = useSelector((state) => state.profilesState);
    const [currentPage, setCurrentPage] = useState(1);
    ...
    return (
        <Fragment>
            {loading ? (
                ...
                <Fragment>
                    <MetaData title={"Search Profiles"} />
                    <h1 id="profiles_heading">Search Profiles</h1>
                            ...
                            <div className="col-12 mb-5">
                                ...
                                <div className="row">
                                    {profiles && profiles
                                        ...
                                        .map((profile) => (
                                            <Profile col={4} key={profile._id} profile={profile} />
                                        ))}
                                </div>
                            </div>
                        </div>
